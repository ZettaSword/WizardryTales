...
public class EntityAIVampAttackMelee extends EntityAIBase {
    World world;
    ...
    public EntityAIVampAttackMelee(EntityCreature p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
