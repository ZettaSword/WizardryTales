 ...
 */
// Mmmm generics...
public class EntityAIAttackSpellSmart<T extends EntityLiving & ISpellCaster> extends EntityAIBase {
	 ...
	 * {@link EntityAIAttackSpellSmart#continuousSpellDuration}.
	 */
	 ...
	 * @param minDistance The minimal distance task is executing.
	 * @param maxAttackDistance The maximum distance the entity should be from its target.
	 ...
	 */
	public EntityAIAttackSpellSmart(T attacker, double speed, float minDistance, float maxAttackDistance, int baseCooldown, int continuousSpellDuration){
		this.cooldown = -1;
	...
	public boolean shouldExecute(){
		...
		if(entitylivingbase == null){
			...
			if(entitylivingbase.getDistanceSq(this.attacker) <= this.minDistance){
				return false;
			}
