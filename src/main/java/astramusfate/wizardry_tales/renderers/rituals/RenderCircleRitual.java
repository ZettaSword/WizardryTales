...
public class RenderCircleRitual extends Render<EntityRitual> {

	private final float rotationSpeed;

	public RenderCircleRitual(RenderManager renderManager, float rotationSpeed){
		super(renderManager);
		this.rotationSpeed = rotationSpeed;
	}

	@Override
	public void doRender(@Nonnull EntityRitual entity, double x, double y, double z, float entityYaw, float partialTicks){
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityRitual entity){
		return null;
	}
