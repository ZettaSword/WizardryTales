...
public abstract class TalesLayerTiledOverlay<T extends EntityLivingBase> implements LayerRenderer<T> {
    ...
    public TalesLayerTiledOverlay(RenderLivingBase<?> renderer, int textureWidth, int textureHeight){
    ...
    public TalesLayerTiledOverlay(RenderLivingBase<?> renderer){
        this(renderer, 16, 16);
    }
