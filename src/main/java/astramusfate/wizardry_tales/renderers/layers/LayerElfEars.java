...
public class LayerElfEars extends LayerArmorBase<ModelBiped>
{
    private final RenderLivingBase<?> renderer;

    public LayerElfEars(RenderLivingBase<?> rendererIn)
    {
        super(rendererIn);
    ...
    public boolean isReady(EntityLivingBase living){
        return Race.is(living, Race.elf);
    }
    ...
    {
        String string = "textures/layers/elf_ears.png";
