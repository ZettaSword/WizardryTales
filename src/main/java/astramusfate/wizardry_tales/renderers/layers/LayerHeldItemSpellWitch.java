...
import astramusfate.wizardry_tales.renderers.RenderSpellWitch;
...
public class LayerHeldItemSpellWitch implements LayerRenderer<EntitySpellWitch>
{
    private final RenderSpellWitch witchRenderer;

    public LayerHeldItemSpellWitch(RenderSpellWitch witchRendererIn)
    {
        this.witchRenderer = witchRendererIn;
    }

    public void doRenderLayer(EntitySpellWitch entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
