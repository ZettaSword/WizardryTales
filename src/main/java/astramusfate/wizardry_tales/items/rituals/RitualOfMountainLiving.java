...
public class RitualOfMountainLiving extends ItemRitual {
    public RitualOfMountainLiving(String name){
    ...
    List<Item> getIngredients() {
        return Lists.newArrayList(TalesItems.mana_dust, Items.IRON_PICKAXE, Item.getItemFromBlock(Blocks.COBBLESTONE));
    }
